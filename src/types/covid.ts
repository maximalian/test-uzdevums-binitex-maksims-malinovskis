...
export interface CovidRecord {
  ...
  continentExp: string;
  // Fourteen-day notification rate per 100k population (optional in the feed).
...
// - Surface missing or optional fields at compile time instead of failing at runtime.
